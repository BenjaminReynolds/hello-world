...
halfAdderTests =
    describe "Half adder"
        [ describe "when the first input is 0"
            ...
            , describe "and the second input is 1"
        ...
        , describe "when the first input is 1"
            [ describe "and the second input is 0"
                [ test "sum is 1 and carry-out is 0" <|
                    \_ ->
                        halfAdder 1 0
...
rippleCarryAdderProperty1 =
    describe "carry-out's relationship with the most significant digits"
        [ fuzz3
            (list (intRange 0 1))
            (list (intRange 0 1))
            (intRange 0 1)
...
rippleCarryAdderProperty2 =
    describe "carry-out's other relationship with the most significant digits"
        [ fuzz3
            (list (intRange 0 1))
            (list (intRange 0 1))
            (intRange 0 1)
    ...
    describe "carry-in's relationship with least significant digits"
        [ fuzz3
            ...
            """
             ...
             carry-in is 0 and the least significant digit of both
             inputs are 0
            """
          <|
            \list1 list2 carryIn ->
...
rippleCarryAdderProperty4 =
    describe "carry-in's other relationship with least significant digits"
        [ fuzz3
            (list (intRange 0 1))
            (list (intRange 0 1))
            (constant 0)
            ...
            \list1 list2 carryIn ->
                let
                    ...
                    setLastDigitToOne digitsList =
                        Array.fromList digitsList
                            |> Array.set (lastIndex digitsList) 1
                            |> Array.toList
