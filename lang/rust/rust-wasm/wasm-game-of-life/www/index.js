import { Universe, Cell } from "wasm-game-of-life-benreyn";
import { memory } from "wasm-game-of-life-benreyn/wasm_game_of_life_benreyn_bg";
...
const fps = new class {
  ...
  render() {
    // Conver the delta time since the last frame render into a measure
